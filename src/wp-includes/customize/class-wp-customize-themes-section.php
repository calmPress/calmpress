			...
			<div class="customize-themes-section themes-section-{{ data.id }} control-section-content themes-php">
				...
				<div class="theme-browser rendered">
					...
					<div class="error unexpected-error" style="display: none; ">
						<p>
							<?php _e( 'An unexpected error occurred. Something may be wrong with WordPress.org or this server&#8217;s configuration. If you continue to have problems, please try the <a href="https://github.com/calmPress/calmpress/issues">Bug tracker</a>.' ); ?>
						</p>
					</div>
					<ul class="themes">
					</ul>
