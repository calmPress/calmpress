 ...
 *
 * Implements compatibility for Blogger API, MetaWeblog API, and MovableType.
 * Additional WordPress API for managing comments, pages, posts,
 * options, etc.
 *
...
class wp_xmlrpc_server extends IXR_Server {
	...
	public function login( $username, $password ) {
		 ...
		 *
		 * Further, the filter does not control whether other custom endpoints that don't
