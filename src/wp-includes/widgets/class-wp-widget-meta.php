...
class WP_Widget_Meta extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'Login, RSS, &amp; calmpress.org links.' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			<?php
			/**
			 * Filters the "Powered by calmPress" text in the Meta widget.
			 *
			 * @since 3.6.0
			 * @since 4.9.0 Added the `$instance` parameter.
			 *
			 * @param string $title_text Default title text for the calmPress.org link.
