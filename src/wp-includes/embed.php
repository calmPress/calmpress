...
/**
 * Enqueue the wp-embed script if the provided oEmbed HTML contains a post embed If oembed is enabled.
 *
...
function wp_maybe_enqueue_oembed_host_js( $html ) {
	if (
		0 != get_option( 'calm_embedding_on')
		&&
			...
			<div class="wp-embed-share-dialog-text">
				<ul class="wp-embed-share-tabs" role="tablist">
					<li class="wp-embed-share-tab-button wp-embed-share-tab-button-wordpress" role="presentation">
						<button type="button" role="tab" aria-controls="<?php echo $share_tab_wordpress_id; ?>" aria-selected="true" tabindex="0"><?php esc_html_e( 'calmPress Embed' ); ?></button>
					</li>
				...
				<div id="<?php echo $share_tab_wordpress_id; ?>" class="wp-embed-share-tab" role="tabpanel" aria-hidden="false">
					...
					<p class="wp-embed-share-description" id="<?php echo $description_wordpress_id; ?>">
						<?php _e( 'Copy and paste this URL into your calmPress site to embed' ); ?>
					</p>
				</div>
...
function the_embed_site_title() {
	$site_title = sprintf(
		...
		esc_url( home_url() ),
		esc_url( get_site_icon_url( 32, admin_url( 'images/calmpresslogo.png' ) ) ),
		esc_url( get_site_icon_url( 64, admin_url( 'images/calmpresslogo.png' ) ) ),
