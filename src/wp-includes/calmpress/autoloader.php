...
const MAP = [
	...
	'calmpress\backup\Struct_Versioned_Data'            => __DIR__ . '/backup/class-struct-versioned-data.php',
	'calmpress\backup\Struct_Plugin_Data'               => __DIR__ . '/backup/class-struct-plugin-data.php',
