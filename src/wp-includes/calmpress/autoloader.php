...
const MAP = [
	...
	'calmpress\identity\Site_Icon'                      => __DIR__ . '/identity/class-site-icon.php',
	'calmpress\identity\Logo'                           => __DIR__ . '/identity/class-logo.php',
	'calmpress\site\Site'                               => __DIR__ . '/site/class-site.php',
	...
	'calmpress\email\User_One_Time_Password_Email'      => __DIR__ . '/email/class-user-one-time-password-email.php',
	'calmpress\email\User_One_Time_Password_Email_Mutator' => __DIR__ . '/email/class-user-one-time-password-email-mutator.php',
	'calmpress\email\User_Invitation_Email'               => __DIR__ . '/email/class-user-invitation-email.php',
	'calmpress\email\User_Invitation_Email_Mutator'       => __DIR__ . '/email/class-user-invitation-email-mutator.php',
	'calmpress\email\User_Account_Activated_Email'        => __DIR__ . '/email/class-user-account-activated-email.php',
	'calmpress\email\User_Account_Activated_Email_Mutator' => __DIR__ . '/email/class-user-account-activated-email-mutator.php',
	'calmpress\email\Existing_User_Invitation_To_Site_Email'         => __DIR__ . '/email/class-existing-user-invitation-to-site-email.php',
	'calmpress\email\Existing_User_Invitation_To_Site_Email_Mutator' => __DIR__ . '/email/class-existing-user-invitation-to-site-email-mutator.php',
	'calmpress\email\Site_Invitation_Accepted_Email'                 => __DIR__ . '/email/class-site-invitation-accepted-email.php',
	'calmpress\email\Site_Invitation_Accepted_Email_Mutator'         => __DIR__ . '/email/class-site-invitation-accepted-email-mutator.php',
	'calmpress\email\Site_Invitation_Declined_Email'                 => __DIR__ . '/email/class-site-invitation-declined-email.php',
	'calmpress\email\Site_Invitation_Declined_Email_Mutator'         => __DIR__ . '/email/class-site-invitation-declined-email-mutator.php',
	'calmpress\email\User_Left_Site_Email'                            => __DIR__ . '/email/class-user-left-site-email.php',
	'calmpress\email\User_Left_Site_Email_Mutator'                    => __DIR__ . '/email/class-user-left-site-email-mutator.php',
	...
	'calmpress\comments\Comment_Syntax_Help_Item'       => __DIR__ . '/comments/class-comment-syntax-help-item.php',
	'calmpress\comments\Comment_Syntax_Help_Item_Collection_Mutator' => __DIR__ . '/comments/class-comment-syntax-help-item-collection-mutator.php',
	'calmpress\comments\Comment_Syntax_Help_Item_Collection' => __DIR__ . '/comments/class-comment-syntax-help-item-collection.php',
	'calmpress\comments\Functions'                      => __DIR__ . '/comments/class-functions.php',
