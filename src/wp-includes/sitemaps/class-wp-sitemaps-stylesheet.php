...
class WP_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$title       = esc_xml( 'XML Sitemap' );
		$description = esc_xml( 'This XML Sitemap is generated by WordPress to make your content more visible for search engines.' );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
			esc_url( 'https://www.sitemaps.org/' ),
			esc_xml( 'Learn more about XML sitemaps.' )
		);
...
XSL;
	...
	public function get_sitemap_index_stylesheet() {
		$css         = $this->get_stylesheet_css();
		$title       = esc_xml( 'XML Sitemap' );
		$description = esc_xml( 'This XML Sitemap is generated by calmPress to make your content more visible for search engines.' );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
			esc_url( 'https://www.sitemaps.org/' ),
			esc_xml( 'Learn more about XML sitemaps.' )
