...
function maybe_add_existing_user_to_blog() {
	...
	wp_die( sprintf( __( 'You have been added to this site. Please visit the <a href="%1$s">homepage</a> or <a href="%2$s">log in</a> using your username and password.' ), home_url(), admin_url() ), __( 'calmPress &rsaquo; Success' ), array( 'response' => 200 ) );
}
