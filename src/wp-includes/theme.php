...
function get_theme_root_uri( $stylesheet_or_template = '', $theme_root = '' ) {
	 ...
	 */
	return apply_filters( 'theme_root_uri', $theme_root_uri, get_option( 'home' ), $stylesheet_or_template );
}
 ...
 *
 * In calmPress just for backward compatibility, always returns empty string.
 *
 * @since 4.7.0
