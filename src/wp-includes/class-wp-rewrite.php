...
class WP_Rewrite {
	...
	public function generate_rewrite_rules( $permalink_structure, $ep_mask = EP_NONE, $paged = true, $feed = true, $forcomments = false, $walk_dirs = true, $endpoints = true ) {
		...
		for ( $j = 0; $j < $num_dirs; ++$j ) {
			...
			if ( $num_toks ) {
				 ...
				 * only contains rules/queries pages etc) to the main regex/query for
				 * this dir
				 */
	...
	public function rewrite_rules() {
		...
		if ( $this->use_verbose_page_rules ) {
			$this->rules = array_merge( $this->extra_rules_top, $robots_rewrite, $favicon_rewrite, $sitemap_rewrite, $registration_pages, $root_rewrite, $comments_rewrite, $search_rewrite, $date_rewrite, $page_rewrite, $post_rewrite, $this->extra_rules );
		} else {
			$this->rules = array_merge( $this->extra_rules_top, $robots_rewrite, $favicon_rewrite, $sitemap_rewrite, $registration_pages, $root_rewrite, $comments_rewrite, $search_rewrite, $date_rewrite, $post_rewrite, $page_rewrite, $this->extra_rules );
		}
