...
if ( ! function_exists( 'wp_new_user_notification' ) ) :
	...
	function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
		...
		$message .= network_site_url( "wp-login.php?action=rp&key=$key&email=" . rawurlencode( $user->user_email ), 'login' ) . "\r\n\r\n";
...
if ( ! function_exists( 'wp_rand' ) ) :
	 ...
	 *
	 * calmPress note: might generate an exception if the OS do not have a good
	 * source for random numbers @see http://php.net/manual/en/function.random-int.php
	 *
	 * @since 2.6.2
