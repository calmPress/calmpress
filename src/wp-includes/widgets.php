...
function wp_widget_rss_output( $rss, $args = array() ) {
	if ( ! function_exists( '\calmpress\readfeeds\wp_widget_rss_output' ) ) {
		if ( is_admin() || current_user_can( 'manage_options' ) ) {
			echo '<p><strong>' . esc_html__( 'You have tried to fetch a feed but do not have the read-feeds core plugin installed.' ) . '</strong></p>';
		}
	}

	\calmpress\readfeeds\wp_widget_rss_output( $rss, $args );
}
