 ...
 * through the proxy. The list should be presented in a comma separated list, wildcards using * are supported. Example. *.example.org</li>
 * </ol>
 *
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'localhost, www.example.com, *.example.org');
 *
