 ...
 * touching global.
 *
 * For calmPress this should return true by default unless the file based cache
 * is not available.
 * 
 * @since 3.7.0
 * @since calmPress 1.0.0 By default true if internal file based cache is available.
 *
