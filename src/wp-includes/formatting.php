 ...
 *
 * @since 0.71
 * @since calmPress 1.0.0 Still not fully RFC complient but uses PHP core
 *                        validator which are more likely to be kept up to date
 *                        with changing RFCs.
 *
...
function is_email( $email ) {
	 ...
	 *
	 * @since 2.8.0
	 * @since calmPress 1.0.0 granular context is not provided, it is always null.
	 *
	 ...
	 */
	return apply_filters( 'is_email', $res, $email, null );
}
...
function sanitize_option( $option, $value ) {
	...
	switch ( $option ) {
		...
		case 'calm_email_delivery':
			$value = calmpress\email\Email_Settings::validate_option_value( $value );
			break;
	}
