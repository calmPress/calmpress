...
class WP_Application_Passwords {
	...
	/**
	 * Gets a user's application login.
	 *
	...
	/**
	 * Decrypt a login generated by ::get_user_application_login and get the user ID.
	 *
	 * @since calmPress 1.0.0
	 *
	 * @param string $login The login string which was supposed to be return from ::get_user_application_login.
	 *
