 ...
 * @since calmpress 1.0.0 remember, id_remember, value_remember and label_remember
 *                        has no impact.
 *
 * @param array $args {
...
/**
 * Displays the generator XML or Comment for RSS, etc.
 *
 ...
 * @since 2.5.0
 *
 * @param string $type The type of generator to output - (html|xhtml|rss2|comment|export).
 */
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		case 'export':
			$gen = '<!-- generator="calmPress/' . esc_attr( get_bloginfo_rss( 'version' ) ) . '" created="' . gmdate( 'Y-m-d H:i' ) . '" -->';
			break;
	}
