 ...
 */
function calmseventeen_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'calmseventeen_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.calmseventeen-front-page) .entry-title,
...
.colors-custom .calmseventeen-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.calmseventeen-front-page .panel-content .recent-posts article,
...
.colors-custom.calmseventeen-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters calm Seventeen custom colors CSS.
	 *
	 * @since calm Seventeen 1.0
	 *
	 ...
	 */
	return apply_filters( 'calmseventeen_custom_colors_css', $css, $hue, $saturation );
}
