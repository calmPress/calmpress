...
<div class="wrap">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'calmseventeen' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
		<?php else : ?>
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'calmseventeen' ); ?></p>
			<?php
				get_search_form();
