...
class WP_Plugin_Install_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		 ...
		 * @since 2.7.0
		 *
		 * @param string[] $tabs The tabs shown on the Add Plugins screen. Defaults include 'popular',
		 *                    and 'favorites'.
		 */
	...
	public function display_rows() {
		...
		<div class="plugin-card plugin-card-<?php echo sanitize_html_class( $plugin['slug'] ); ?>">
			...
			if ( ! $compatible_php || ! $compatible_wp ) {
				...
				if ( ! $compatible_php && ! $compatible_wp ) {
					$incompatible_notice_message .= __( 'This plugin does not work with your versions of calmPress and PHP.' );
					...
					$incompatible_notice_message .= __( 'This plugin does not work with your version of calmPress.' );
