...
function get_site_screen_help_tab_args() {
	return array(
		...
		'content' =>
			...
			'<p>' . __( '<strong>Info</strong> &mdash; The site URL is rarely edited as this can cause the site to not work properly. The Registered date and Last Updated date are displayed. Network admins can mark a site as archived, spam and deleted, to remove from public listings or disable.' ) . '</p>' .
