...
function wp_install_defaults( $user_id ) {
	...
	$first_comment_email = ! empty( $first_comment_email ) ? $first_comment_email : 'wapuu@example.org';
	$first_comment_url = ! empty( $first_comment_url ) ? $first_comment_url : 'https://example.org/';
...
Commenter avatars come from <a href="https://gravatar.com">Gravatar</a>.' );
	...
	update_option( 'sidebars_widgets', array( 'wp_inactive_widgets' => array(), 'sidebar-1' => array( 0 => 'search-2', 1 => 'recent-posts-2', 2 => 'recent-comments-2', 3 => 'categories-2' ), 'sidebar-2' => array(), 'sidebar-3' => array(), 'array_version' => 3 ) );
	if ( ! is_multisite() )
