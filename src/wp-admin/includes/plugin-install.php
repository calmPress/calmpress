...
<div id="<?php echo $_tab; ?>-content" class='<?php echo $_with_banner; ?>'>
	...
	$tested_wp      = ( empty( $api->tested ) || version_compare( wordpress_core_version(), $api->tested, '<=' ) );
	$compatible_wp  = ( empty( $api->requires ) || version_compare( wordpress_core_version(), $api->requires, '>=' ) );
	...
	if ( ! $tested_wp ) {
		...
		_e( '<strong>Warning:</strong> This plugin <strong>has not been tested</strong> with your current version of calmPress.' );
		echo '</p></div>';
	} elseif ( ! $compatible_wp ) {
		echo '<div class="notice notice-error notice-alt"><p>';
		_e( '<strong>Error:</strong> This plugin <strong>requires a newer version of calmPress</strong>.' );
		if ( current_user_can( 'update_core' ) ) {
			printf(
				/* translators: %s: "Update WordPress" screen URL */
				' ' . __( '<a href="%s" target="_parent">Click here to update calmPress</a>.' ),
