...
<div id="<?php echo $_tab; ?>-content" class='<?php echo $_with_banner; ?>'>
	...
	if ( ! $tested_wp ) {
		wp_admin_notice(
			__( '<strong>Warning:</strong> This plugin <strong>has not been tested</strong> with your current version of calmPress.' ),
			array(
				'type'               => 'warning',
				'additional_classes' => array( 'notice-alt' ),
			)
		...
		$compatible_wp_notice_message = __( '<strong>Error:</strong> This plugin <strong>requires a newer version of calmPress</strong>.' );
