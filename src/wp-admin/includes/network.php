...
function network_step1( $errors = false ) {
	...
	<p><?php _e( 'Fill in the information below and you&#8217;ll be on your way to creating a network of calmPress sites. We will create configuration files in the next step.' ); ?></p>
	<?php
