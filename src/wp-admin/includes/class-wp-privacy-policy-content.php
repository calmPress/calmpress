...
class WP_Privacy_Policy_Content {
	...
	public static function get_default_content( $description = false, $blocks = true ) {
		...
		if ( $description ) {
			...
			/* translators: Default privacy policy text. */
			$strings[] = '<p>' . __( 'When you log in, we will also set up several cookies to save your login information and your screen display choices. Login cookies last for 30 days, and screen options cookies last for a year. If you log out of your account, the login cookies will be removed.' ) . '</p>';
			/* translators: Default privacy policy text. */
