...
function wp_get_popular_importers() {
	...
	$cache_key = 'popular_importers_' . md5( $locale . wordpress_core_version() );
	...
	if ( ! $popular_importers ) {
		...
		$options = array( 'user-agent' => 'calmPress/' . calmpress_version() . '; ' . home_url( '/' ) );
