					...
					<td>
						<select name="mock_role" id="mock-role">
							<?php if ( in_array( 'administrator', $user->roles, true ) ) : ?>
								<option value="" <?php selected( '', $current_mocked_role ); ?>><?php echo esc_html( translate_user_role( 'Administrator' ) ); ?></option>
								<option value="editor" <?php selected( 'editor', $current_mocked_role ); ?>><?php echo esc_html( translate_user_role( 'Editor' ) ); ?></option>
							<?php else : ?>
								<option value="" <?php selected( '', $current_mocked_role ); ?>><?php echo esc_html( translate_user_role( 'Editor' ) ); ?></option>
							<?php endif; ?>
