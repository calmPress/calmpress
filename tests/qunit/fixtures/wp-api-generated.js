            ...
            "endpoints": [
                {
                    ...
                    "args": {
                        ...
                        "calm_authors": {
                            "required": false,
                            "default": [],
                            "description": "Limit result set to all items that have the specified term assigned in the calm_authors taxonomy.",
                            "type": "array",
                            "items": {
                                "type": "integer"
                            }
                        ...
                        "calm_authors_exclude": {
                            "required": false,
                            "default": [],
                            "description": "Limit result set to all items except those that have the specified term assigned in the calm_authors taxonomy.",
                            "type": "array",
                            "items": {
                                "type": "integer"
                            }
        ...
        "_links": {
            ...
            "wp:term": [
                ...
                },
                {
                    ...
                    "embeddable": true,
                    "href": "http://example.org/wp-json/wp/v2/calm_authors?post=3015"
                }
            ],
            "curies": [
                {
            ...
            "wp:term": [
                {
                    "taxonomy": "calm_authors",
                    "embeddable": true,
                    "href": "http://example.org/wp-json/wp/v2/calm_authors?post=3018"
                }
            ],
            "curies": [
                {
            ...
            "wp:term": [
                {
                    "taxonomy": "calm_authors",
                    "embeddable": true,
                    "href": "http://example.org/wp-json/wp/v2/calm_authors?post=3021"
                }
            ],
            "curies": [
                {
...
mockedApiResponse.CategoriesCollection = [
    ...
    },
    {
        ...
        "count": 0,
        "description": "",
        "link": "http://example.org/category/uncategorized/",
        "name": "Uncategorized",
        "slug": "uncategorized",
        "taxonomy": "category",
        "parent": 0,
        ...
        "_links": {
            "self": [
                {
                    "href": "http://example.org/wp-json/wp/v2/categories/1"
                }
            ],
            "collection": [
                {
                    "href": "http://example.org/wp-json/wp/v2/categories"
                }
            ],
            "about": [
                {
                    "href": "http://example.org/wp-json/wp/v2/taxonomies/category"
                }
            ],
            "wp:post_type": [
                {
                    "href": "http://example.org/wp-json/wp/v2/posts?categories=1"
                }
            ],
            "curies": [
                {
