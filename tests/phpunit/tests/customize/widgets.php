...
class Tests_WP_Customize_Widgets extends WP_UnitTestCase {
	...
	public function test_get_widget_control() {
		...
		$this->assertStringContainsString( '<input type="hidden" name="id_base" class="id_base" value="recent-posts"', $widget_control );
	...
	public function test_get_widget_control_parts() {
		...
		$this->assertStringContainsString( '<input type="hidden" name="id_base" class="id_base" value="recent-posts"', $widget_control_parts['control'] );
