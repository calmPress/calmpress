...
class Tests_User_Slashes extends WP_UnitTestCase {
	...
	public function test_add_user() {
		...
		$this->assertEquals( self::SLASH_7, $user->display_name );
		$this->assertEquals( self::SLASH_3, $user->description );
		...
		$this->assertEquals( self::SLASH_2, $user->display_name );
		$this->assertEquals( self::SLASH_4, $user->description );
	}
