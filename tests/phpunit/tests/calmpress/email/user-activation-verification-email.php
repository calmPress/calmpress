<?php
/**
 * Unit tests covering User_Activation_Verification_Email class.
 *
 * @package calmPress
 * @since 1.0.0
 */
 ...
 */
class Mock_Verification_Observer implements User_Activation_Verification_Email_Mutator {
...
class User_Activation_Verification_Email_Test extends WP_UnitTestCase {
	...
	public function test_constructor() {
		...
		$email = new User_Activation_Verification_Email( $user );
	...
	public function test_mutators() {
		...
		$mutate_notification = new Mock_Verification_Observer( 'tasti' );
		User_Activation_Verification_Email::register_mutator( $mutate_notification );
		$email->send();
