...
class WP_Test_REST_Post_Types_Controller extends WP_Test_REST_Controller_Testcase {
	...
	public function test_get_item() {
		...
		$data = $response->get_data();
		$this->assertSame( array( 'category', 'post_tag', \calmpress\post_authors\Post_Authors_As_Taxonomy::TAXONOMY_NAME ), $data['taxonomies'] );
	}
	...
	public function test_get_item_page() {
		...
		$data = $response->get_data();
		$this->assertSame( array( \calmpress\post_authors\Post_Authors_As_Taxonomy::TAXONOMY_NAME ), $data['taxonomies'] );
	}
