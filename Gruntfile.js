...
module.exports = function(grunt) {
		...
		copy: {
			...
			'admin-js': {
				files: {
					...
					[ WORKING_DIR + 'wp-admin/js/network-identity.js' ]: [ './src/js/_enqueues/admin/network-identity.js' ],
					...
					[ WORKING_DIR + 'wp-admin/js/leave-site.js' ]: [ './src/js/_enqueues/admin/leave-site.js' ],
					...
					[ WORKING_DIR + 'wp-admin/js/text-based-avatar.js' ]: [ './src/js/_enqueues/admin/text-based-avatar.js' ],
					...
					[ WORKING_DIR + 'wp-admin/js/site-profile.js' ]: [ './src/js/_enqueues/admin/site-profile.js' ],
					...
					[ WORKING_DIR + 'wp-admin/js/cp-logo-selection.js' ]: [ './src/js/_enqueues/cp/logo-selection.js' ],
				}
			},
			'includes-js': {
				files: {
		...
		patch:{
			options: {
				file_mappings: {
					...
					'src/wp-admin/js/leave-site.js': 'src/js/_enqueues/admin/leave-site.js',
					...
					'src/wp-admin/js/text-based-avatar.js': 'src/js/_enqueues/admin/text-based-avatar.js',
					'src/wp-admin/js/site-profile.js': 'src/js/_enqueues/admin/site-profile.js',
					...
					'src/wp-admin/js/cp-logo-selection.js': 'src/js/_enqueues/cp/logo-selection.js',
				}
			}
		},
		imagemin: {
	...
	grunt.registerTask( 'verify:source-maps', function() {
		const ignoredFiles = [
			...
			'build/wp-includes/js/dist/edit-site.js',
		];
